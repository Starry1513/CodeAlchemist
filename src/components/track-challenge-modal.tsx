...
export function TrackChallengeModal(props: {
  ...
  useEffect(() => {
    if (hasInitializedTrack) return;
    if (!trackOptions.data) return;
    const initial =
          ...
          <div className="space-y-5">
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/20 p-4">
              ...
              <div className="mt-2 grid gap-3 md:grid-cols-3">
                ...
                <div>
                  <div className="text-xs font-medium text-zinc-400">Tooling</div>
                  <div className="mt-1 flex flex-wrap gap-2">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/20 p-4">
              ...
              <div className="mt-3 space-y-2">
                {activeTrack &&
                trackOptions.data?.recommendationsByTrack?.[activeTrack]?.length ? (
                      ...
                      >
                        <div className="min-w-0">
                          ...
                          <div className="text-xs text-zinc-400">
                            Assignment: {r?.assignment ? "available" : "missing"}
                          </div>
              ...
              {trackOptions.data?.options?.map((opt: any) => (
                ...
                >
                  ...
                  <div className="mt-auto flex items-center justify-between gap-2">
                    <div className="text-xs text-zinc-400">
                      {trackOptions.data?.recommendedTrackKey === opt.trackKey ? (
                      ...
                      >
                        ...
                        <div className="flex shrink-0 gap-2">
                          <Button
                            disabled={
                              !r.assignment ||
                              claimAssignment.isLoading ||
                              !props.repoFullName ||
                              !activeTrack
                            }
                            onClick={async () => {
                              if (!props.repoFullName || !activeTrack) return;
                              ...
                              router.push(`/evaluation/${resp.candidateAssignmentId}`);
                            }}
                          >
                            Start
                          </Button>
