...
export function CandidateProfile({
  ...
  async function startChallengeForSelectedRepo() {
    ...
    try {
      ...
      setStartError(e instanceof Error ? e.message : "Failed to start challenge.");
    } finally {
                    ...
                    <div className="mt-4 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                      {startError ? (
                        ...
                        <div className="text-xs text-zinc-500">
                          Use this repo to generate tracks and pick an assignment.
                        </div>
                      )}
                      <Button
                      ...
                      >
                        {isStartingChallenge ? "Starting…" : "Start Challenge with this repo"}
                      </Button>
                    </div>
                  </div>
                ) : (
